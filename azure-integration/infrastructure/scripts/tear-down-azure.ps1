...
$resourceGroups = Get-AzResourceGroup -Tag @{ business_unit="sales-training"; company="datadog"; env="development" }
...
Write-Host "waiting for '$($deletionJobs.Count)' resource group deletion jobs to complete. will wait for '180' seconds."
Wait-Job -Job $deletionJobs -Timeout 180
